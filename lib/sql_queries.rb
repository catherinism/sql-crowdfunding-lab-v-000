...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT title, SUM(projects.funding_goal)-SUM(pledges.amount) FROM projects
  INNER JOIN pledges
  ON pledges.project_id = projects.id
  WHERE projects.funding_goal < pledges.amount AND projects.funding_goal = pledges.amount
  GROUP BY pledges.project_id
  "
end
